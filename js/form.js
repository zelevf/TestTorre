...
const extraDiv = document.querySelector(".inputContainer");
const sendContact = document.getElementById("buttonSubmit");
const inputValue = document.getElementById("emailConsulta");
